...
**StreamFlix Rentals** is a DVD rental service with both brick-and-mortar stores and an online mail-based DVD rental model. To stay competitive and make data-driven decisions, the company builds a Snowflake-powered data warehouse to answer questions such as:
